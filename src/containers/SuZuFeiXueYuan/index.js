...
export default  class SuZuFeiXueYuan extends Component {
	state={
		cover:null,
		detail:null,
		items:[
	...
	getGuanyushanger=()=>{
		_fetch(url.get_articles, {subject_id:4, page:1})
		.then(data=>{
			this.setState({
				detail:data
			})
	...
	render() {
		return (
			<div className="SuZuFeiXueYuan" ref="about">
